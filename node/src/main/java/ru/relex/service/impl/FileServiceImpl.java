...
public class FileServiceImpl implements FileService {
    ...
    private final AppPhotoDAO photoDAO;
    private final CryptoTool cryptoTool;

    public FileServiceImpl(AppDocumentDAO appDocumentDAO, BinaryContentDAO binaryContentDAO, AppPhotoDAO photoDAO, CryptoTool cryptoTool) {
    ...
    public AppPhoto processPhoto(Message telegramMessage) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            return photoDAO.save(transientAppPhoto);
        } else {
            throw new UploadFileException("Bad response from telegram service: " + response);
        }
    }
